...
def main() -> int:
    """⚠ WRAPPED IN main() 2026-09-16. This was a flat script, so merely IMPORTING it globbed
    /data2, rewrote CHECKPOINT_LEDGER.json and printed the whole ledger — which made the
    cleanup import sweep produce 90 lines of table and, worse, meant any tool that imported
    the package touched an artifact. Behaviour when run as a script is unchanged."""
